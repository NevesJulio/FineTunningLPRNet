...
def get_parser():
    ...
    parser.add_argument('--phase_train', default=True, type=bool,
    ...
    parser.add_argument('--lr_schedule', default=[4, 8, 12, 14, 16],
...
def train():
    ...
    print("Example file:", train_dataset.img_paths[0])
